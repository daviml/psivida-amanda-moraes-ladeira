          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            <div className="sm:text-center md:mx-auto md:max-w-2xl lg:col-span-6 lg:text-left">
              ...
              <h1 className="text-4xl font-bold tracking-tight text-slate-900 sm:text-5xl md:text-6xl">
                Cuide do seu <span className="text-primary">bem-estar mental</span> com autoconhecimento profundo.
              </h1>
              <p className="mt-6 text-lg text-slate-600 leading-relaxed">
                Um espaço seguro de escuta para explorar o inconsciente. Atendimento online especializado para ajudar você a viver com mais autenticidade e sentido.
              </p>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
             ...
             <div>
                ...
                <div className="space-y-4 text-lg text-slate-600">
                  <p>
                    Olá! Sou psicóloga clínica com abordagem psicanalítica. Minha prática é baseada na escuta qualificada do inconsciente, acreditando no potencial de transformação através da compreensão profunda de si mesmo.
                  </p>
                  <p>
                    Possuo formação contínua em psicanálise, garantindo um acolhimento autêntico e livre de julgamentos, focado na escuta das singularidades de cada sujeito.
                  </p>
                </div>
                <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
                   <div className="flex items-center gap-3">
                      <CheckCircle2 className="text-primary h-6 w-6" />
                      <span className="text-slate-700 font-medium">Análise Pessoal Contínua</span>
                   </div>
                   <div className="flex items-center gap-3">
                      <CheckCircle2 className="text-primary h-6 w-6" />
                      <span className="text-slate-700 font-medium">Estudos Teóricos Rigorosos</span>
                   </div>
                   <div className="flex items-center gap-3">
                      <CheckCircle2 className="text-primary h-6 w-6" />
                      <span className="text-slate-700 font-medium">Supervisão Clínica Constante</span>
                   </div>
                </div>
             </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
              Como posso ajudar na sua análise
            </h2>
            <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">
              Ofereço sessões de escuta qualificada para explorar sua subjetividade, compreender os mecanismos inconscientes e encontrar formas de lidar com o sofrimento e os desafios da vida, buscando mais sentido e autonomia.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-sm p-8 border border-slate-100 hover:shadow-md transition-shadow">
              ...
              <p className="text-slate-600 mb-6">
                Sessões focadas na exploração do inconsciente, autoconhecimento profundo e tratamento de conflitos internos. Tudo no conforto da sua casa.
              </p>
              ...
              <Link to="/agendar" className="text-primary font-medium hover:text-teal-700 flex items-center gap-1">
                Agendar uma Sessão <ArrowRight className="h-4 w-4" />
              </Link>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm p-8 border border-slate-100 hover:shadow-md transition-shadow">
              ...
              <p className="text-slate-600 mb-6">
                Espaço mediado para facilitar o diálogo, resolver conflitos e fortalecer os vínculos afetivos entre casais ou membros da família, focado na compreensão das dinâmicas inconscientes que sustentam as relações.
              </p>
              <ul className="space-y-2 mb-6">
                 <li className="text-sm text-slate-500 flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-sky-600"></div>Sessões de 50 minutos</li>
                 <li className="text-sm text-slate-500 flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-sky-600"></div>Foco na escuta e mediação</li>
              </ul>
